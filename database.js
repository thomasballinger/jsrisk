...
var collection = function(collectionName, callback, retry){
    if (!retry) {retry = 0;}
    if (status == "connecting"){
        if (retry < MAX_RETRIES){
            setTimeout(function(){
                console.log('Retrying mongo query(', retry, ')');
                collection(collectionName, callback, retry + 1);
            }, 200);
        } else {
...
exports.getAllGameNames = function(db, callback){
    collection('games', function(err, collection){
...
exports.getGameByName = function(name, db, callback){
    collection('games', function(err, collection){
